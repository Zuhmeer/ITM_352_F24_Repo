import pandas as pd
# Read in a CSV file containing restate in NYC, and turn it into a DataFrame
...
# Select properties with 500 or more units and drop necessary columns
...
# Drop the rows with NaN values and drop duplicate rows 
